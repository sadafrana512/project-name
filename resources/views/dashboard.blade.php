...
<body>
  <div class="container-scroller">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Time Stamping</h4>
                </div>
                <div>
                <form action="{{ route('download.zip') }}" method="GET">
                @csrf
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                <div class="card-body">
                  <p class="card-title">All images</p>
                  <div class="row">
    ...
    @if (isset($record))
        <tr>
            <td>
                @foreach (json_decode($record->file) as $image)
                    <img src="{{ asset($image) }}" class="img-fluid" alt="Image" style="width: 200px; height: auto; border-radius: 0;">
                @endforeach
            </td>
        </tr>
    @else
  ...
  <script>
    document.getElementById('downloadButton').addEventListener('click', function() {
        var imageElements = document.querySelectorAll('.img-fluid');
        var imagePaths = [];
        imageElements.forEach(function(element) {
            imagePaths.push(element.src.replace(window.location.origin, ''));
        });

        document.getElementById('imagePaths').value = JSON.stringify(imagePaths);
